...
var container_width = 769;
var container_height = 1366;
// Em % (ex: 10%)
var margin = 0;
...
function enableIni() {
  let container_init_course = document.querySelectorAll('.container-init-course');
  if (container_init_course.length > 0) {
    screen.goto();
  }
}

function cleanStyles() {
  let x = document.querySelector("#loaded_content").children;
